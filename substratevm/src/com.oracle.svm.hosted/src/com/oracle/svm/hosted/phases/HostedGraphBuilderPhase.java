...
class HostedBytecodeParser extends SubstrateBytecodeParser {
    ...
    HostedBytecodeParser(GraphBuilderPhase.Instance graphBuilderInstance, StructuredGraph graph, BytecodeParser parent, ResolvedJavaMethod method, int entryBCI, IntrinsicContext intrinsicContext, SubstrateInlineDuringParsingPlugin.InvocationData inlineInvocationData) {
